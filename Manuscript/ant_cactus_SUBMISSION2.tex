...
\revise{This lack of evidence for a sampling effect likely stems from the strong competitive dominance and high frequency of \textit{L. apiculatum}, which restricts the population-level impacts of alternative partners. 
...
\revise{Furthermore, our simulations exploring the absence of competitive dominance (Appendix \ref{appendix:C}) suggest that the turnover dynamics of the partner guild dictate which diversity mechanisms can manifest. 
