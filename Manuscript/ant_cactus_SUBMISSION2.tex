...
\revise{Using simulations in which all ant species were artificually forced to be equally frequent (further explained in Appendix \ref{appendix:C}), we found the same fitness patterns as described above. \linelabel{res:appendixc}}
