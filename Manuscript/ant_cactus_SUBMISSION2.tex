...
First, the fitness consequences of sequential partnering play out over long time scales due to the accumulation of partners across time rather than the effects of multiple partners at once. 
...
Finally, alternative partners may have different demographic effects (e.g., one that enhances survival and another that enhances reproduction) that contribute differently to overall fitness of a focal mutualist.  
...
Integrating long-term data from across the life cycle within a stochastic demographic modeling framework therefore provides a powerful opportunity to diagnose the fitness consequences of partner diversity and turnover.  
}
