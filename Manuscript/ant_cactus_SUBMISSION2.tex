...
We also quantified the abundances and identities of any cactus herbivores observed, and recorded the occurrence of herbivore damage (described further in Appendix B). 
...
\ali{}{I am not sure where in the appendix you want this to be referenced? --TOM: I don't know what you are asking. There is a figure of the posterior distribution for the means. YOu should reference the figure.}
...
\revise{\tom{Using the simulations where all ants had equal frequencies across sizes}{Can you make this more helpful to readers who have not (and may not) see the appendix? It is not clear how ``equal frequencies across sizes'' is relevant here or how it should be interpreted.} (further explained in Appendix C), we found the same fitness patterns as described above. \linelabel{res:appendixc}}
...
In scenarios in which partner fluctuations were uncorrelated or, especially, negatively correlated, the non-synchronous model exhibited a stronger benefit of diversity than the synchronous model \tom{(Figures)}{Update this.}, as expected under the portfolio effect hypothesis.}
...
\revise{To further explore the potential for portfolio effects, we conducted simulations in which inter-annual fluctuations in ant effects were manipulated to be independent or negatively correlated; we found evidence of the portfolio effect in both scenarios, but especially when ant effects were negatively correlated (Appendix E).
...
This means there is no evidence of portfolio effect in this system.}{I do not udnerstand why this is here. It does not fit in an appendix about Additional Methods and Parameters.}
...
%% Seeds Produced
\paragraph{Seeds Per Fruit Model}
...
Comparison between posterior distributions revealed that \textit{C. opuntiae} tended plants produced fewer seeds per flower than \textit{L. apiculatum} tended plants and vacant plants with 80\% and 87\% confidence, respectively.
...
%% Precensus Survival\
	...
	\tom{Seeds in year one experience germination rates between 50\% and 100\% with a mean of 62\% germination.
	Seeds in year two experience germination rates between 50\% and 98\% with a mean of 58\% germination.}{I do not understand what these ranges are.}
...
\tom{In the first scenario, we forced the correlation among ant species to be zero, representing complete independence of partner responses across years. 
In the second scenario, we forced the correlation as close to -1 as possible, representing maximally anti-correlated partner responses.}{Need to say more about how you did this.}
