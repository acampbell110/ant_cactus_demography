...
These broader, network-structured interactions are characteristic of generalized or diffuse mutualisms, in which mutualists interact with multiple partners rather than engaging in strict one‐to‐one pairings \citep{Aizen2014, Prior2015}.
...
\revise{Second, even within a mutualist guild, the benefits conferred by alternative partner species can vary by method, efficiency, or timing \citep{Stachowicz2005,Bronstein2006,Stanton2003}. \linelabel{res:L53}
...
\revise{Furthermore, \textit{C. opuntiae}-tended plants had fewer seeds per fruit (115.0[79.5--165.5] seeds) than vacant (147.2[114.1--189.9] seeds) or \textit{L. apiculatum}-tended plants (142.4[100.7--200.2] seeds), likely due to pollinator interference \citep{Ohm2014}. \linelabel{res:viability}}
...
\revise{Using the simulations where all ants had equal frequencies across sizes (further explained in Appendix C), we found the same fitness patterns as described above. \linelabel{res:appendixc}}
...
\revise{\section*{Appendix E}\label{appendix:E}
