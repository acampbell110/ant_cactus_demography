...
Mutualisms are considered more context dependent than other species interactions \cite{Chamberlain2014,Frederickson2013}, meaning the magnitude and sign of interaction strength are often determined by the surrounding environment and species' identities. 
  ...
  Historically, pairwise studies, where two species engage in mutualism with only each other, were central in the field of mutualisms, it has since been shown that pairwise studies are poor predictors of the effects of \tom{multi-species mutualistic interactions}{It is very important to give this an operational definition early in the paper.} \cite{Afkhami2014,Palmer2010}, where more than two species engage in mutualisms.
...
\tom{For these reasons, pairwise studies cannot be accurately used to predict the outcomes of multi-species mutualisms \cite{Palmer2010, Stanton2013, Chamberlain2014, Song2020}.}{This re-states something you said two sentences ago.}
...
In some cases, the quality of the benefits offered varies leading to \tom{some partners which benefit the individual}{what is implicit here is that your definition of multi-species mutualism is where a focal species has multiple partners -- that is not at all clear.}, some which have neither a positive or negative impact on the individual, and some which negatively impact the host \cite{Bronstein1994,Bronstein2001a,Afkhami2014,Song2020,West2007,Frederickson2013,Jones2015}. 
In cases where the partner offers benefits, the function, or type of benefits, offered by the partner can vary \cite{Stanton2003}.\tom{}{The structure of this paragraph is disorienting because you have a list of mechanisms in sentence two, then you introduce new ideas, then you return to these same mechanisms here.}
