...
\begin{document}
	...
	\response{We have reorganized the code and data. All code and data are now in a single directory. We removed all `setwd()` calls and replaced absolute pathways with relative pathways. We have also eliminated the need for .Rds files and instead suggest that all outputs be generated through the code in file 02\_cholla\_ant\_IPM\_vital\_rates.R.}
