...
bigmatrix<-function(params,lower,upper,matsize){  
  ...
  Fmat[1,3:(n+2)]<-fec1_c
  Fmat[1,(n+3):(2*n+2)]<-fec1_l
  Fmat[1,(2*n+3):(3*n+2)]<-fec1_o
  Fmat[1,(3*n+3):(4*n+2)]<-fec1_v
  ...
  # Graduation from 1-yo bank and 2-yo bank to cts size = germination * size distn * pre-census survival
  ...
  beta1_v<- invlogit(params[71])*recruits(y,params)*h*invlogit(params[91] + params[92]*xb)*beta(TRUE)
  beta2_v<- invlogit(params[81])*recruits(y,params)*h*invlogit(params[91] + params[92]*xb)*beta(TRUE)  
  Tmat[3:(n+2),1]<-beta1_c
  Tmat[3:(n+2),2]<-beta2_c
  Tmat[(n+3):(2*n+2),1]<-beta1_l
  Tmat[(n+3):(2*n+2),2]<-beta2_l
  Tmat[(2*n+3):(3*n+2),1]<-beta1_o
  Tmat[(2*n+3):(3*n+2),2]<-beta2_l
  Tmat[(3*n+3):(4*n+2),1]<-beta1_l
  Tmat[(3*n+3):(4*n+2),2]<-beta2_l
  ...
  crem_liom<-t(outer(y,y,ptxy,params=params,"crem","liom"))*h
  crem_other<-t(outer(y,y,ptxy,params=params,"crem","liom"))*h
  liom_vac<-t(outer(y,y,ptxy,params=params,"liom","vac"))*h
  liom_crem<-t(outer(y,y,ptxy,params=params,"liom","crem"))*h
  liom_liom<-t(outer(y,y,ptxy,params=params,"liom","liom"))*h
  liom_other<-t(outer(y,y,ptxy,params=params,"liom","other"))*h
  other_vac<-t(outer(y,y,ptxy,params=params,"other","vac"))*h
  other_crem<-t(outer(y,y,ptxy,params=params,"other","crem"))*h
  other_liom<-t(outer(y,y,ptxy,params=params,"other","liom"))*h
  other_other<-t(outer(y,y,ptxy,params=params,"other","other"))*h
  
  Tmat[3:(n+2),3:(n+2)]<- crem_crem## [1,1]
  Tmat[3:(n+2),(n+3):(2*n+2)]<-crem_liom ## [1,2] 
  Tmat[3:(n+2),(2*n+3):(3*n+2)]<-crem_liom ## [1,3]
  Tmat[3:(n+2),(3*n+3):(4*n+2)]<-crem_liom ## [1,4]
  Tmat[(n+3):(2*n+2),3:(n+2)]<- crem_other## [2,1]
  Tmat[(n+3):(2*n+2),(n+3):(2*n+2)]<- vac_crem## [2,2]
  Tmat[(n+3):(2*n+2),(2*n+3):(3*n+2)]<-crem_liom ## [2,3]
  Tmat[(n+3):(2*n+2),(3*n+3):(4*n+2)]<-crem_liom ## [2,4] 
  Tmat[(2*n+3):(3*n+2),3:(n+2)]<- crem_other## [3,1]
  Tmat[(2*n+3):(3*n+2),(n+3):(2*n+2)]<- vac_crem## [3,2]
  Tmat[(2*n+3):(3*n+2),(2*n+3):(3*n+2)]<-crem_liom ## [3,3]
  Tmat[(2*n+3):(3*n+2),(3*n+3):(4*n+2)]<-crem_liom ## [3,4] 
  Tmat[(3*n+3):(4*n+2),3:(n+2)]<- crem_other## [4,1]
  Tmat[(3*n+3):(4*n+2),(n+3):(2*n+2)]<- vac_crem## [4,2]
  Tmat[(3*n+3):(4*n+2),(2*n+3):(3*n+2)]<-crem_liom ## [4,3]
  Tmat[(3*n+3):(4*n+2),(3*n+3):(4*n+2)]<-crem_liom ## [4,4] 
  
  # Put it all together
  IPMmat<-Fmat+Tmat
  
  return(IPMmat=IPMmat)
}
...
stable <- list()
  ...
  big_list<-bigmatrix(cholla, lower, upper, matsize)
  mat <- big_list
  eig <- eigen(mat)
