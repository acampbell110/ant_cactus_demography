...
ptxy<-function(x,y,params,i, j, ant){
  xb=pmin(pmax(x,cholla_min),cholla_max)
  ## Crem
  vac_vac = sx(xb,params)$s_vac*gxy(xb,y,params)$g_vac*transition_beta[1,1] #i=vac
  vac_crem = sx(xb,params)$s_vac*gxy(xb,y,params)$g_vac*transition_beta[1,2] #i=vac
  crem_crem = sx(xb,params)$s_crem*gxy(xb,y,params)$g_crem*transition_beta[2,2] #i=crem
  crem_vac = sx(xb,params)$s_crem*gxy(xb,y,params)$g_crem*transition_beta[2,1] #i=crem
  ...
  ## Liom
  vac_vac = sx(xb,params)$s_vac*gxy(xb,y,params)$g_vac*transition_beta[1,1] #i=vac
  vac_liom = sx(xb,params)$s_vac*gxy(xb,y,params)$g_vac*transition_beta[1,3] #i=vac
  liom_liom = sx(xb,params)$s_liom*gxy(xb,y,params)$g_liom*transition_beta[3,3] #i=liom
  liom_vac = sx(xb,params)$s_liom*gxy(xb,y,params)$g_liom*transition_beta[3,1] #i=liom
  ...
  ## Other
  vac_vac = sx(xb,params)$s_vac*gxy(xb,y,params)$g_vac*transition_beta[1,1] #i=vac
  vac_other = sx(xb,params)$s_vac*gxy(xb,y,params)$g_vac*transition_beta[1,4] #i=vac
  other_other = sx(xb,params)$s_other*gxy(xb,y,params)$g_other*transition_beta[4,4] #i=other
  other_vac = sx(xb,params)$s_other*gxy(xb,y,params)$g_other*transition_beta[4,1] #i=other
